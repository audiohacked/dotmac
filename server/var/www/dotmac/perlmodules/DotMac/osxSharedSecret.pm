...
#	$r->server('AppleDotMacServer');
	my $response_data = '<?xml version="1.0" encoding="ISO-8859-1"?><methodResponse><params><param><value><struct><member><name>data</name><value>/mRnb5L+QPwFS6C1jhMvefo/ki4=</value></member><member><name>name</name><value>dotmacusername.members.mac.com.</value></member></struct></value></param></params></methodResponse>';
